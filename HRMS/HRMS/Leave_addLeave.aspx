<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="Leave_addLeave.aspx.cs" Inherits="HRMS.Leave_addLeave" %>
                            ...
                            <div class="child">
                                <div class="mb-2">
                                    <h4 style="margin-left: auto; margin-right: auto; text-align: center;">
                                        Weekends are not allowed. Please choose again
                                    </h4>
                                    <br />
                                </div>
                            </div>
    ...
    <div class="modal fade modal" id="fails" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    <div class="col-md-12">
                         <button class="btn btn-secondary" type="button" style="width:100%" data-dismiss="modal" onclick="javascript:window.location.href='Leave_addLeave.aspx'">Close</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="child">
                                <div class="mb-2">
                                    <h4 style="margin-left: auto; margin-right: auto; text-align: center;">
                                        ...
                                        <asp:Label runat="server" Style="text-align: center">Are you sure to submit the following leave
