<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="EditLeave.aspx.cs" Inherits="HRMS.EditLeave" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="container-fluid" style="background: white">
        ...
        <fieldset>
            <legend align="center">Edit Leave (Leave ID:
            ...
            <div class="col-xl-12">
                <fieldset style="border: 1px solid black;">
                    ...
                    <div class="container-fluid">
                        <div class="form-outline mb-12">
                            <asp:Label runat="server" class="form-label" for="DdlTypeLeave" Width="100%">Leave Type </asp:Label>
                            <asp:TextBox ID="ddlvalue" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                            <asp:Label runat="server" ID="r1">Remaining Leave for </asp:Label>
                            <asp:Label runat="server" ID="r2"></asp:Label>
                            <asp:Label runat="server" ID="getremaining"></asp:Label>
                            <asp:Label runat="server" ID="pastQuota" Visible="false"></asp:Label>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                <div class="form-outline">
                                    ...
                                    <input type="date" class="form-control" id="pick_date" name="pickup_date" onchange="cal()" value="<%= this.getsstartdate %>" />
                                </div>
                                <br />
                                ...
                                <div class="form-outline">
                                    ...
                                    <input type="date" class="form-control" id="drop_date" name="dropoff_date" onchange="cal()" value="<%= this.getenddate %>" />
                                </div>
                                <br />
                                ...
                                <div class="form-outline">
                                    ...
                                    <input type="text" class="form-control" id="numdays2" name="numdays" readonly="true" value="<%= this.getdduration %>" />
                ...
                <div class="col-md-12 text-center">
                    ...
                    <asp:Button runat="server" class="btn btn-success" Style="color: white" Text="Update" ID="update" OnClick="update_Click" />
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    <div class="col-md-12">
                        <button class="btn btn-secondary" style="width: 100%" type="button" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade modal" id="Submitmodal" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                            ...
                            <div class="child">
                                <div class="mb-2">
                                    <h4 style="margin-left: auto; margin-right: auto; text-align: center;">
                                        ...
                                        <asp:Label runat="server">Are you sure to update the following leave
                ...
                <div class="modal-footer text-center">
                    <div class="col-md-12">
                        <asp:Button class="btn btn-secondary" runat="server" type="button" Text="Cancel" aria-hidden="true" OnCommand="changeback"></asp:Button>
                        <asp:Button runat="server" class="btn btn-success" CommandName="updating" Text="Update" OnCommand="updating"></asp:Button>
                    </div>
                </div>
            </div>
        </div>
