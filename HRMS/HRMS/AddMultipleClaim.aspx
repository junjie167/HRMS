<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeFile="AddMultipleClaim.aspx.cs" Inherits="HRMS.AddMultipleClaim" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  ...
  align-items: center;
        ...
        <fieldset style="border: 1px solid black; padding: 20px;">
            ...
            <div class="row mb-5">
                <div class="col">
                    <div class="form-outline">
                        ...
                        <asp:TextBox ID="txtDateFrom" class="form-control dateinputformat" placeholder="dd/mm/yyyy" runat="server" MaxLength="10"></asp:TextBox>
                    </div>
                </div>
                <div class="col">
                    <div class="form-outline">
            ...
            <div class="row mb-2">
                <div class="col-12 table-responsive">
                    <asp:GridView ID="gvMultiClaim" CssClass="gvtable" runat="server" AutoGenerateColumns="False" Width="100%" Style="text-align: center">
                        <Columns>
                            <asp:TemplateField HeaderText="Claim Type">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlCliamType" class="form-control" runat="server">
                                        <asp:ListItem>Meal Expenses</asp:ListItem>
                                        <asp:ListItem>Medical</asp:ListItem>
                                        <asp:ListItem>Phone Allowance</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="Description">
                                <ItemTemplate>
                                    <asp:TextBox ID="tbDes" class="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Amt S$">
                                <ItemTemplate>
                                    <asp:TextBox ID="tbAmt" class="form-control" runat="server" onkeypress="return isDigit(event,this.value);"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Attachment">
                                <ItemTemplate>
                                    <input type="file" id="fulAtt" class="form-control-file" style="float: left;" runat="server" />
                                    <asp:LinkButton ID="lbtnAtt" runat="server" OnClick="lblAttOnClick"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
            ...
            <div class="mb-4 text-center">
                <asp:ImageButton ID="btnAdd" runat="server" ImageUrl="images/add.png" Height="40px" OnClick="btnAdd_Click" Width="40px" />
            </div>
        </fieldset>
        <br />
    ...
    <div class="modal fade modal" id="oneRowModal" data-keyboard="false" data-backdrop="static">
        <%--<div class="modal-dialog modal-lg">--%>
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            <div class="modal-content">
                    ...
                    <div class="form-group">
                        <div class="container">
                            <div class="child">
                                <div class="mb-2">
                                <h4>
                                    <asp:Label ID="Label11" runat="server" Text="Unable to Add Single Claim"></asp:Label>
                                </h4>
                            </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <i class=" icon-checkmark3 position-right"></i>
                    <asp:Button ID="Button3" runat="server" class="btn btn-secondary button-design" Text="Close" />
                </div>
            </div>
        </div>
    </div>
